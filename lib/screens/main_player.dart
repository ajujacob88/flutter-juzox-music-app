...
class _MainPlayerState extends State<MainPlayer> with TickerProviderStateMixin {
  ...
  double getThresholdHeight(double baseHeight) {
    // Adjust calculation as needed (e.g., return baseHeight * 0.75 for 3/4th size)
  ...
  Widget build(BuildContext context) {
    ...
    double screenHeight = MediaQuery.of(context).size.height;
    print(
        'screen height is $screenHeight and thrsold height is ${getThresholdHeight(6.0)}');
    bool isSmallerScreen = screenHeight < 604; // Adjust threshold as needed
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            color: Colors.red,
                            width: 43, // Adjust size as needed
                            height: 43,
                            child: IconButton(
