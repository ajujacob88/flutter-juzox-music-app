...
//PLEASE STASH IT WHILE STARTING AT THALANAD
                ...
                RefreshIndicator(
                  ...
                  child: CustomScrollView(
                    slivers: [
                      ...
                      //             color: const Color.fromARGB(255, 44, 84, 118),
                      //             height: 100,
                      //             child: Text('Item:'),
                      //           ),
                      //           Container(
                      //             alignment: Alignment.center,
                      //             color: Color.fromARGB(255, 31, 11, 82),
                      //             height: 100,
                      //             child: Text('Item2:'),
                      //           ),
                      //           Container(
...
// class MyStickyRowDelegate extends SliverPersistentHeaderDelegate {
//   final Widget child;

//   const MyStickyRowDelegate({required this.child});

//   @override
//   double get minExtent => 30; // Minimum height of the row
//   @override
//   double get maxExtent => 30; // Maximum height of the row

//   @override
//   Widget build(
//       BuildContext context, double shrinkOffset, bool overlapsContent) {
//     return Container(
//       color: Colors.white, // Set background color for the row
//       child: child,
//     );
//   }

//   @override
//   bool shouldRebuild(covariant MyStickyRowDelegate oldDelegate) => false;
// }
