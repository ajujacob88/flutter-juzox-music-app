      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            title: Row(
              children: [
                Image.asset(
                  ...
                  height: 30,
                  //color: const Color.fromARGB(158, 105, 240, 175),
                  color: const Color.fromARGB(158, 64, 195, 255),
                ),
                Expanded(
                  child: Container(
                    height: 30,
            ...
            //     color: Colors.red, // Maintain transparency
            //     child: Row(
            //       children: [
            //         // const Spacer(), // Add spacer for centering
            //         SizedBox(
            //           width: MediaQuery.of(context).size.width *
            //               0.8, // Adjust width as needed
            //           child: ListView.builder(
            //             scrollDirection: Axis.horizontal,
            //             shrinkWrap: true, // Prevent vertical scrolling
            //             itemCount: _menuItems.length,
            //             itemBuilder: (context, index) {
            //               final menuItem = _menuItems[index];
            //               return TextButton(
            //                 onPressed: () {
            //                   // Handle menu item tap (e.g., filter songs based on genre)
            //                   print('Menu item tapped: $menuItem');
            //                 },
            //                 child: Text(
            //                   menuItem,
            //                   style: TextStyle(
